            ...
            <div className="navbar z-10 fixed bg-black bg-opacity-30 w-full lg:w-10/12 mx-auto text-white ">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu text-black menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-300 rounded-box w-52">
                            {navLinks}
                        </ul>
                    </div>
                    <div className="flex flex-col items-center">
                        <h3 className="btn btn-ghost normal-case text-xs md:text-xl">Boss Chef</h3>
                        <h3 className="text-sm md:text-2xl font-base">RESTAURANT</h3>
                    </div>
                ...
                <div className="navbar-end flex lg:flex-row gap-3">
                    ...
                    <h3 className="text-base md:text-xl lg:text-2xl">{user?.displayName}</h3>
